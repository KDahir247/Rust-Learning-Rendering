...
fn main() {
    ...
    let vertex1 = util::vertex::Vertex::new(-0.5, -0.5 );
    let vertex2 = util::vertex::Vertex::new(-0.0, 0.5 );
    let vertex3 = util::vertex::Vertex::new(0.5, -0.25);
    ...
    let vertex_shader = util::shader::read_shader("shader/triangle/triangle.vert")
        .expect("Failed to read vertex shader");

    let fragment_shader  = util::shader::read_shader("shader/triangle/triangle.frag")
